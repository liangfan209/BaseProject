...
import com.clkj.login.finger.ui.BiometricPromptDialog;
import com.clkj.login.finger.utils.CryptoObjectHelper;
...
public class BiometricPromptApi23 implements IBiometricPromptImpl {
    ...
    public void authenticate(@Nullable CancellationSignal cancel,
        ...
        mDialog.show(((FragmentActivity) mActivity).getSupportFragmentManager(), "BiometricPromptApi23");
