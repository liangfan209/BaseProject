...
import com.bq.wallet.pay.weixin.WXPay;
import com.bq.wallet.pay.weixin.WXPayInfoImpli;
import com.bq.wallet.requset.bean.WxOrderInfo;
...
//        }
    ...
    public static void wexinPay(Activity activiy, WxOrderInfo.WcBean info, IPayCallback callBack) {
        //实例化微信支付策略
        String wxAppId = "wx22a8fc65e8d220af";
        WXPay wxPay = WXPay.getInstance(activiy, wxAppId);
        //构造微信订单实体。一般都是由服务端直接返回。
        String timestamp = info.getTimeNumber();
        String partnerid = "1517459321";
        String prepayid = info.getPrepayId();
        String appid = "wx22a8fc65e8d220af";
        String noncestr = info.getNonce_str();
