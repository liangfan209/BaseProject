...
public class MyClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        layout.setBackgroundColor(0xf2f2f2);
        ...
        LayoutParams animationLlt = new LayoutParams(density.dip2px(40), density.dip2px(40));
        mLottieView = (LottieAnimationView) LinearLayout.inflate(context,com.fan.baseuilibrary.R.layout.lottie_animation,null);
        lpArrow.addRule(CENTER_VERTICAL);
        animationLlt.addRule(CENTER_IN_PARENT);
//        lpArrow.addRule(LEFT_OF, android.R.id.widget_frame);
        mArrowView = new ImageView(context);
        addView(mLottieView, animationLlt);
