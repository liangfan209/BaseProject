package com.fan.baseuilibrary.view.captcha;
...
public class Captcha extends LinearLayout {
    ...
    public Captcha(@NonNull final Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        drawableId = typedArray.getResourceId(R.styleable.Captcha_src, R.mipmap.hdyzm1);
        ...
        blockSize = typedArray.getDimensionPixelSize(R.styleable.Captcha_blockSize, AppUtils.dp2px(getContext(), 50));
        typedArray.recycle();
        init();
    }
    ...
    private void init() {
        View parentView = LayoutInflater.from(getContext()).inflate(R.layout.captcha_container, this, true);
